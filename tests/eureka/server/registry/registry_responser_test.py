...
class TestRegistryResponser:
    def setup_method(self):
        ...
        self.responser = registry.get_responser()
    ...
    def test_query_application(self):
        response = self.responser.query_application("no_app")

        assert "{}" == response

    def test_query_application(self):
        response = self.responser.query_application("app_2")
