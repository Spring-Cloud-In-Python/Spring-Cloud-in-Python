...
def dose_not_contains_key(headers: Dict[str, str], keys: List[str]):
    return not any(headers.get(key) for key in keys)
...
class TestForwardedHeadersFilter:
    ...
    def test_Given_forward_headers_When_filter_Then_return_modified_headers(self):
    ...
    def test_Given_forward_headers_does_not_exist_When_filter_Then_should_append_forwarded_header(self):
...
class TestXForwardedHeadersFilter:
    ...
    def test_Given_remote_addr_is_none_When_filter_Then_return_modified_headers(self):
    ...
    def test_Given_x_forwarded_headers_do_not_exist_When_filter_Then_return_modified_headers(self):
    ...
    def test_Given_x_forwarded_headers_When_filter_Then_append_headers(self):
        headers = {
...
class TestRemoveHopByHopHeadersFilter:
    ...
    def test_Given_hop_by_hop_header_When_filter_Then_remove_all_of_them(self):
        hop_by_hop_headers = {}
    ...
    def test_Given_hop_by_hop_header_in_lower_case_When_filter_Then_remove_all_of_them(self):
        hop_by_hop_headers = {}
        for header in self.filter.HEADERS_REMOVED_ON_REQUEST:
    ...
    def test_Given_Connection_header_When_filter_Then_remove_all_of_them(self):
